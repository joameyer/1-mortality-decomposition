...
# SLURM directives
# Submit this script from inside hpc-1-mortality-decomposition/ with: sbatch run_logistic_baseline.sh
# Run preprocessing first so artifacts/chapter1/model_ready/chapter1_primary_model_ready_dataset.csv exists.
#SBATCH --job-name=chapter1_logistic_baseline
...
cmd=(
    python
    run_chapter1_logistic_baseline.py
...
echo "[$(date)] Starting Chapter 1 ASIC logistic-regression baseline job"
...
echo "[$(date)] Chapter 1 ASIC logistic-regression baseline job finished"
