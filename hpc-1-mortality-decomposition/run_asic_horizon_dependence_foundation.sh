...
# This writes the Package 1 horizon-dependence foundation outputs.
#SBATCH --job-name=chapter1_asic_horizon_foundation
...
output_dir="${OUTPUT_DIR:-${project_root}/artifacts/chapter1/evaluation/asic/horizon_dependence/foundation}"
horizons="${HORIZONS:-}"
...
cmd=(
    python
    run_chapter1_asic_horizon_dependence_foundation.py
...
echo "[$(date)] Starting Chapter 1 ASIC horizon-dependence foundation job"
...
echo "[$(date)] Chapter 1 ASIC horizon-dependence foundation job finished"
