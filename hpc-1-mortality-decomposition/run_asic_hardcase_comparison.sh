...
# sbatch run_asic_hardcase_comparison.sh
...
#SBATCH --job-name=chapter1_asic_hardcase_comparison
...
output_dir="${OUTPUT_DIR:-${project_root}/artifacts/chapter1/evaluation/asic/hard_cases/primary_medians/logistic_regression/issue_3_2_asic_hardcase_comparison}"
...
cmd=(
    python
    run_chapter1_asic_hardcase_comparison.py
